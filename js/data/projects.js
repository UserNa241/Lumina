...
const IMAGES = [
    ...
    "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=1000&auto=format&fit=crop", // 6. Landscape (Neon)
    "https://images.unsplash.com/photo-1558470598-a5dda9640f6b?q=80&w=1000&auto=format&fit=crop", // 7. Portrait (Art)
    ...
    "https://images.unsplash.com/photo-1535378437327-1e58aeeb6381?q=80&w=1000&auto=format&fit=crop", // 14. Landscape (Arch)
    "https://images.unsplash.com/photo-1620641788421-7f1c918e7455?q=80&w=1000&auto=format&fit=crop", // 15. Portrait (Pink)
...
export const generateProjects = (count = 100) => {
    ...
    for (let i = 1; i <= count; i++) {
        ...
        // i=1 -> uses IMAGES[0], i=21 -> uses IMAGES[0]
